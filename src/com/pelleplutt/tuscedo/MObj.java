...
public abstract class MObj implements MSet {
  ...
  public void put(Object key, M m) {
    throw new ProcessorError(type + " object cannot be modified (put)");
  }

  @Override
  public void remove(M m) {
    throw new ProcessorError(type + " object cannot be modified (remove)");
  }

  @Override
  public MSet copyShallow() {
    throw new ProcessorError(type + " object cannot be copied (copyShallow)");
  }

  @Override
  public void insert(int ix, M m) {
    throw new ProcessorError(type + " object cannot be modified (insert)");
    
  }

  @Override
  public void add(M m) {
    throw new ProcessorError(type + " object cannot be modified (add)");
  }

  @Override
  public void set(M mix, M m) {
    throw new ProcessorError(type + " object cannot be modified (set)");
  }
